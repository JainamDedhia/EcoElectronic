...
//         try {
//             await addVolunteer(newVolunteer);
//             setNewVolunteer({ name: "", email: "", status: "Pending" }); // Reset input fields
//             refreshData(); // Ensure data is refreshed
//         } catch (error) {
//             console.error("Error adding volunteer:", error);
//         }
...
(()=>{
    const e = new Error("Cannot find module '@/components/services/volunteerService'");
...
const AddVolunteerPage = ()=>{
    const [volunteer, setVolunteer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        name: "",
        email: "",
        phone: "",
        address: ""
    ...
    const handleSubmit = async ()=>{
        if (!volunteer.name || !volunteer.email || !volunteer.phone || !volunteer.address) {
...
const __TURBOPACK__default__export__ = AddVolunteerPage;
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__09bc8e._.js.map