(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_f8114c._.js", {
...
const BulkScrapePage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BulkScrapePage.useEffect": ()=>{
            const fetchRequests = {
                "BulkScrapePage.useEffect.fetchRequests": async ()=>{
                    ...
                    const data = querySnapshot.docs.map({
                        "BulkScrapePage.useEffect.fetchRequests.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["BulkScrapePage.useEffect.fetchRequests.data"]);
                    setRequests(data);
                }
            }["BulkScrapePage.useEffect.fetchRequests"];
            const fetchVolunteers = {
                "BulkScrapePage.useEffect.fetchVolunteers": async ()=>{
                    ...
                    const data = querySnapshot.docs.map({
                        "BulkScrapePage.useEffect.fetchVolunteers.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["BulkScrapePage.useEffect.fetchVolunteers.data"]);
                    setVolunteers(data);
                }
            }["BulkScrapePage.useEffect.fetchVolunteers"];
            fetchRequests();
            fetchVolunteers();
        }
    }["BulkScrapePage.useEffect"], []);
                        ...
                        children: requests.map((request)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            "Special Request: ",
                                            request.isSpecialRequest ? 'Yes' : 'No'
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/admin/BulkEwaste/page.tsx",
                                        lineNumber: 57,
...
_s(BulkScrapePage, "FyxxaUm4fI2Kpao1ZkNhItUmOlk=");
_c = BulkScrapePage;
const __TURBOPACK__default__export__ = BulkScrapePage;
var _c;
__turbopack_refresh__.register(_c, "BulkScrapePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_f8114c._.js.map